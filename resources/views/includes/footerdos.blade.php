        ...
        <div class="row">
            ...
            <div class="col-md-4 col-lg-3 mx-auto my-md-4 my-0 mt-4 mb-1">
                ...
                <ul class="list-unstyled">
                    <li>
                        <p>
                            <i class="fa fa-map-marker"></i> Mérida, Yucatán</p>
                    </li>
                    <li>
                    <p>
                    ...
                    <li>
                    <p>
                        <i class="fa fa-phone" style="color: white"></i> +52 1 999 274 6989
                    </p>
                    </li>
                </ul>
            ...
            <div class="col-md-2 col-lg-2 text-center mx-auto my-4">
                ...
                <a type="button" class="btn-floating ">
                    <p>
                        <i class="fa fa-facebook-official" style="color: white"></i> Facebook
                    </p>
                </a>
                <!-- Twitter -->
                <a type="button" class="btn-floating ">
                <p>
                        <i class="fa fa-twitter" style="color: white"></i> Twitter
                </p>
                </a>
